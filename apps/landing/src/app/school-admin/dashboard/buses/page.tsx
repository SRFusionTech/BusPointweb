            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="/school-admin/dashboard/routes" target="_blank" className="text-[11px] font-semibold text-purple-400 hover:text-purple-300">
                    + Create a new route
                  </Link>
                </div>
                {routes.length > 0 ? (
                  ...
                  <div className="px-4 py-3 rounded-xl border border-dashed border-slate-700 text-xs text-slate-500 flex items-center gap-2">
                    <MapPin size={13} />
                    No routes configured yet. <Link href="/school-admin/dashboard/routes" className="text-purple-400 hover:text-purple-300 font-semibold">Create one →</Link>
                  </div>
                )}

...
import { getSchool } from '@/lib/schoolAdminApi';
import { useState, useEffect } from 'react';

const nav = [
  { icon: LayoutDashboard, label: 'Dashboard',     href: '/school-admin/dashboard' },
  { icon: Bus,             label: 'Buses',          href: '/school-admin/dashboard/buses' },
  { icon: RouteIcon,       label: 'Routes',         href: '/school-admin/dashboard/routes' },
  { icon: UserCheck,       label: 'Drivers',        href: '/school-admin/dashboard/drivers' },
  { icon: Users,           label: 'Parents',        href: '/school-admin/dashboard/parents' },
  { icon: CreditCard,      label: 'Subscriptions',  href: '/school-admin/dashboard/subscriptions' },
  { icon: Map,             label: 'Live Map',       href: '/school-admin/dashboard/map' },
];

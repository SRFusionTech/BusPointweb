...
export default function SuperAdminDashboard() {
  ...
  const statCards = [
    { icon: Building2,    label: 'Total Schools',    value: stats?.schools      ?? '—', color: 'sky',    href: '/dashboard/schools' },
    { icon: Bus,          label: 'Total Buses',       value: stats?.buses        ?? '—', color: 'purple', href: '/dashboard/schools' },
    { icon: Users,        label: 'Total Users',       value: stats?.users        ?? '—', color: 'green',  href: '/dashboard/schools' },
    { icon: ClipboardList,label: 'Pending Requests',  value: stats?.pendingRequests ?? '—', color: 'amber',  href: '/dashboard/requests' },
  ];
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800">
            ...
            <Link href="/dashboard/schools" className="text-xs text-sky-400 hover:text-sky-300 font-medium flex items-center gap-1">
